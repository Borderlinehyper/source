    ...
    var basicBot = {
        ...
        commands: {
            ...
            acronymCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        return API.sendChat(subChat(basicBot.chat.letter, {
                            letter: this.getLetters,
                            letter2: this.getLetters2,
                            letter3: this.getLetters3,
                            letter4: this.getLetters4,
                            letter5: this.getLetters5,
                            letter6: this.getLetters6
                        }));
                    }
                }
            },
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (space === -1) {
                            ...
                            if (user === false || !user.inRoom) {
                                ...
                                return API.sendChat(subChat(basicBot.chat.candy, {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (space === -1) {
                            ...
                            if (user === false || !user.inRoom) {
                                ...
                                return API.sendChat(subChat(basicBot.chat.selffortune, {
                                    nameto: user.username,
                                    fortune: this.getFortune()
                                }));
                            }
                            else {
                                return API.sendChat(subChat(basicBot.chat.fortune, {
                                    nameto: user.username,
                                    namefrom: chat.un,
                                    fortune: this.getFortune()
                                }));
            ...
            joinCommand: {
                ...
                functionality: function (chat, cmd) {
                    var dj = API.getDJ();
                    var djname = dj.username;
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void (0);
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                    else {
                        for (var i = 0; i < basicBot.room.roulette.participants.length; i++) {
                            ...
                            } else if (basicBot.room.roulette.rouletteStatus && basicBot.room.roulette.participants.indexOf(chat.uid) < 0) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (space === -1) {
                            ...
                            if (user === false || !user.inRoom) {
                                ...
                                return API.sendChat(subChat(basicBot.chat.selfk1tt, {
                                    nameto: user.username,
                                    k1tt: this.getK1tt()
                                }));
                            }
                            else {
                                return API.sendChat(subChat(basicBot.chat.k1tt, {
                                    nameto: user.username,
                                    namefrom: chat.un,
                                    k1tt: this.getK1tt()
                                }));
            ...
            propsCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var user = basicBot.userUtilities.lookupUserName(name);
                        var dj = API.getDJ().username;
                        return API.sendChat(subChat(basicBot.chat.prop, {
                            namefrom: chat.un,
                            dj: dj,
                            prop: this.getProps()
                        }));
            ...
            propscuntCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var user = basicBot.userUtilities.lookupUserName(name);
                        var dj = API.getDJ().username;
                        return API.sendChat(subChat(basicBot.chat.propcunt, {
                            namefrom: chat.un,
                            dj: dj,
                            propcunt: this.getPropscunt()
                        }));
                    }
                }
            },
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (space === -1) {
                            ...
                            if (user === false || !user.inRoom) {
                                ...
                                return API.sendChat(subChat(basicBot.chat.shot, {
                                    nameto: user.username,
                                    namefrom: chat.un,
                                    shot: this.getShots()
                                }));
